        ...
        <div className="w-full">
          ...
          <div className="border rounded-md p-4" style={{ borderColor: `${project.color}80` }}>
              ...
              <div className="h-full w-full bg-[#0f2c4a] rounded-sm p-3 text-white font-sans text-xs">
                ...
                <div className="h-full w-full bg-[#eef1f4] rounded-lg font-sans text-xs text-gray-800 flex">
                  <div className="w-12 bg-white flex flex-col items-center py-4 space-y-6">
                  ...
                  <div className="flex-1 p-4">
                    ...
                    <div className="grid grid-cols-6 gap-3 mb-4 text-[10px]">
